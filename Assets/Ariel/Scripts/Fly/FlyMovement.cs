...
public class FlyMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (lifeTime <= 0 && !willLeave)
        {
            ...
            {
                case 0:
                    target = new Vector3(this.transform.position.x, 40, this.transform.position.z);
                    break;
                case 1:
                    target = new Vector3(this.transform.position.x, -40, this.transform.position.z);
                    break;
                case 2:
                    target = new Vector3(40, this.transform.position.y, this.transform.position.z);
                    break;
                case 3:
                    target = new Vector3(-40, this.transform.position.y, this.transform.position.z);
                    break;
                case 4:
                    target = new Vector3(40, 40, this.transform.position.z);
                    break;
                case 5:
                    target = new Vector3(40, -40, this.transform.position.z);
                    break;
